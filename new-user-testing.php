...
<head>
    ...
    <title>LabLogic Diagnostics | New User Testing</title>
                        ...
                        <div class="col-lg-6">
                           ...
                           <div class="card shadow mb-4">
                             ...
                             <div class="form-group">
                                            ...
                                            <option value="Troponin">Troponin (Chest Pain & Heart Attack)</option>
                                            <option value="Cholesterol">Cholesterol (Lipid Profile)</option>   
                                           <option value="Serological Test">Serological Tests</option>
                                           <option value="Blood Sugar">Blood Sugar (HbA1c) (Diabetes)</option>  
                                           <option value="Urea & Electrolytes">Urea & Electrolytes (U&E) (Abnormal Heart Rhythms)</option>  
                                           <option value="Full Blood Count">Full Blood Count (FBC) (Myocarditis)</option>
                                           <option value="International Normalised Ratio">International Normalised Ratio (INR) (Anticoagulant)</option>
                                           <option value="B-Type Natriuretic Peptide">B-Type Natriuretic Peptide (BNP) (Signs Of Heart Failure)</option>
                                           <option value="Thyroid Test">Thyroid Test (Thyroid)</option>
                                           <option value="Liver Blood Tests">Liver Blood Tests (LFTs)</option>
                                           <option value="Arterial Blood Gas">Arterial Blood Gas (Breathing or Lung Problems)</option> 
                                           <option value="Group & Save Test">Group & Save Tests (Blood Transfusion)</option>    
                                              </select>
                                        </div>
