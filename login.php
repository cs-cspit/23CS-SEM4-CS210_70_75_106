...
<head>
    ...
    <title>LabLogic Diagnostics | Admin Login</title>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-12 col-lg-12 col-md-9">
                <h3 align="center" style="margin-top:4%;color:#fff">LabLogic Diagnostics | Blood Testing Management System</h3>
                    ...
                    <form name="login" method="post">
                        <div class="row">
                            <div class="col-lg-8 d-none d-lg-block bg-login-image">
                                <img src="surgeon-holding-blood-test_53876-94763.avif" alt="Login Image" class="img-fluid" style="height:100%; width: 2000px; object-fit:cover;">
                            </div>
                            <div class="col-lg-4">
                                <div class="p-5">
