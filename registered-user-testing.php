...
<head>
    ...
    <title>LabLogic Diagnostics</title>
                        ...
                        <div class="col-lg-6">
                           ...
                           <div class="card shadow mb-4">
                             ...
                             <div class="form-group">
                                            ...
                                            <option value="Virus Isolation">Virus Isolation</option>   
                                           <option value="Serological Test">Serological Tests</option>
                                           <option value="Nucleic Acid Detection">Nucleic Acid Detection</option>  
                                           <option value="Antigen Detectio">Antigen Detectio</option>  
